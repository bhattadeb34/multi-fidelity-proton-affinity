...
def main():
    ...
    data_root = next((p for p in (project_dir / "data", project_dir.parent / "data") if p.exists()), project_dir / "data")
    parser.add_argument("--input", default=str(data_root / "screening/zinc_raw/filtered_821k.csv"),
                        help="Input CSV with smiles + latent_1/2/3 columns")
    parser.add_argument("--output-dir", default=str(data_root / "screening/kmeans_selection"),
