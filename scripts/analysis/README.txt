...
| `audit_release.py` | Read-only audit of tracked filenames, credentials, personal paths, Python syntax, and SHA-256 manifests. | Terminal pass/fail report. |
| `audit_selected_feature_correlations.py` | Reconstructs each production outer-training fold and measures residual correlation among its selected features. | `results/selected_feature_correlation_audit.json`. |
...
python scripts/analysis/audit_selected_feature_correlations.py
